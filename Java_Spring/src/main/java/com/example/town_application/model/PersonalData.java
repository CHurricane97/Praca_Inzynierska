...
public class PersonalData {
    ...
    @OneToMany(mappedBy = "personalDataForEvaluation", cascade = CascadeType.ALL)
    private Collection<Evaluation> evaluationsByPersonalDataId;
    @OneToMany(mappedBy = "personalDataForMotions", cascade = CascadeType.ALL)
    private Collection<Motion> motionsByPersonalDataId;
